...
```
    ...
    Solve with presicion: 
        ...
        We obtain: J(u) = 3.276261E-01

        mean(||dJ_i||) = 8.280190E-03

    With 7 iterations,     In 0.35447 seconds

Elapsed time is 0.354995 seconds.
...
```
    ...
    Solve with presicion: 
        ...
        We obtain: J(u) = 1.566386E-01

        mean(||dJ_i||) = 8.104505E-03

    With 6 iterations,     In 0.29546 seconds

Elapsed time is 0.296143 seconds.
