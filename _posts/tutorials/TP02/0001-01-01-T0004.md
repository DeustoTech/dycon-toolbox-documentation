...
[TIME,SPACE]=meshgrid(time,space);
surf(TIME',SPACE',iCP1.UOptimal(:,1:SIZ(2)-1))
title('Control')
ylabel('space discretization')
xlabel('Time')
```
...
Error in ./imgs-matlab/copiaRM (line 171)
line(xline,odeEqn.Y(end,:),'Color','blue')
