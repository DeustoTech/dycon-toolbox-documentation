...
The LQR control is given by the matlab routine care(), as the application $t \mapsto -Kz(t)$, where the matrix $K$, of size $m \times d$ is an output of care(), where $m$ is the dimention of the input space and is equal to one.
...
![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_01.png)

![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_02.png)
...
![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_03.png)

![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_04.png)
...
![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_05.png)

![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_06.png)
...
![](./../../assets/imgs/WP99/P0008/transport_system_LQR_control-md_07.png)
